...
<div
  class="px-6 bg-transparent {w==='w-68' ? 'ml-68' : 'ml-20'}"
...
>
   ...
   <span class="text-sm font-semibold leading-5 select-none text-cadetblue">Timothy Oyewu</span>
   <span class="text-xs font-normal leading-3 tracking-tighter text-right select-none text-cadetblue">Coordinator</span>
   </div>
    </div>
    </div>
</div>
